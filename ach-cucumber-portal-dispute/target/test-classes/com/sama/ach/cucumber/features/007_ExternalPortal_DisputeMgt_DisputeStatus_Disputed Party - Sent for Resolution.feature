Feature: 007_ExternalPortal_DisputeMgt_DisputeStatus_Disputed Party - Sent for Resolution
  @07_Ext_DS_DisputedPartySentforResolution
  Scenario Outline: Disputed Party - Sent for Resolution Status Check
