@Ext_DisputeStatus
Feature: 011_ExternalPortal_DisputeMgt_DisputeStatus_Disputer Party - Sent for Resolution
 @11_Ext_DS_DisputerPartySentforResolution
 Scenario Outline: Disputer Party - Sent for Resolution Status Check
