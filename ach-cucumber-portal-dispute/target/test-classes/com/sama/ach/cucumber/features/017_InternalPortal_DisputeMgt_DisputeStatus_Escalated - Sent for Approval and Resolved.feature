...
Feature: 017_InternalPortal_DisputeMgt_DisputeStatus_Escalated - Sent for Approval and Resolved
@017_Int_EscalatedSentforApprovalandResolved
 Scenario Outline: InternalPortal_Escalated Sent for Approval and Resolved Status Check
