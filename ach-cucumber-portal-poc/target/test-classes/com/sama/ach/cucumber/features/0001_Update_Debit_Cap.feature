@Ext_DebitCap
Feature: Update Debit Cap under Debit Cap Management
@Ext_DebitCap_Valid 
Scenario Outline: Update Debit Cap with valid value under Debit Cap Management page 
	...
	When Click the "Yes" button on "Confirm Debit Cap Change" pop up screen in "Debit Cap Management" page
	Then Below "confirmation" message will be displayed for "Change Debit Cap" 
		"""
		The request is successfully submitted for approvals. The request will be reviewed and actioned.
        """
	And Close the browser 
    Examples: 
      |Browser_Name | Portal_Name |      Username             |    Password                | Updated Debit Cap | Reason for Debit Cap Update  |
      |  Chrome     | External    | dev_SAALBI_allAccess_user | dev_SAALBI_allAccess_user  |      1010         |    Business Requirements     |
    # |  Chrome     | External    | dev_SABJAZ_allAccess_user | dev_SABJAZ_allAccess_user  |      1020         |    Business Requirements     |
    # |  Chrome     | External    | dev_SASABB_allAccess_user | dev_SASABB_allAccess_user  |      1030         |    Business Requirements     |
    # |  Chrome     | External    | dev_SANCBK_allAccess_user | dev_SANCBK_allAccess_user  |      1040         |    Business Requirements     |
####################################################################################################
####################################################################################################
...
Scenario Outline: Update Debit Cap without entring values under Debit Cap Management page 
	...
	And Close the browser 
    Examples: 
      | Browser_Name| Portal_Name |      Username             |    Password               | Blank_Updated_Debit_Cap | Blank_Reason_for_Debit_Cap_Update  |
...
Scenario Outline: Update Debit Cap with invalid value under Debit Cap Management page 
	...
	And Close the browser 
    Examples: 
      |Browser_Name| Portal_Name |      Username             |    Password                | Invalid_Updated_Debit_Cap | Reason for Debit Cap Update  |
      | Chrome     | External    | dev_SAALBI_allAccess_user | dev_SAALBI_allAccess_user  |      1010.45              |    Business Requirements     |
#     | Chrome     | Internal    | dev_allAccess_user2       | dev_allAccess_user2        |      25000500             |    Business Requirements     |
#########################################################################################################################
@Ext_DebitCap_Cancel
Scenario Outline: Selection of the Cancel button under Debit Cap Management page
	...
	And Close the browser 
    Examples: 
	  |Browser_Name| Portal_Name |      Username             |    Password               | Updated_Debit_Cap | Reason for Debit Cap Update  |
	  | Chrome     | External    | dev_SAALBI_allAccess_user | dev_SAALBI_allAccess_user |      1011         |    Business Requirements     |
	# | Chrome     | Internal    | dev_allAccess_user2       | dev_allAccess_user2       |      25000500             |    Business Requirements     |
#####################################################################################################################
@Ext_DebitCap_NoConfirmation 
