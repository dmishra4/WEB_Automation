@Ext_DisputeStatus
Feature: 12_ExternalPortal_DisputeMgt_DisputeStatus_Escalated
 @12_Ext_DS_Escalated
  Scenario Outline: Escalated Status Check for External Portal
...
#     |    Chrome   | External    |dev_SAALBI_allAccess_user|dev_SAALBI_allAccess_user| 20190808000000045C1B00000000000301 |AlBilad Bank  | Bank AlJazira |Customer complaint|Wrong information|Dispute Occoured |dev_SABJAZ_allAccess_user|dev_SABJAZ_allAccess_user|%RUNTIME% |                |Final Resolution      | dev_SABJAZ_disputeteam_user|dev_SABJAZ_disputeteam_user|   Rejected     |dev_SAALBI_allAccess_user2| dev_SAALBI_allAccess_user2|
      |    Firefox  | External    |dev_SAALBI_allAccess_user|dev_SAALBI_allAccess_user| 20190808000000045C1B00000000000301 |AlBilad Bank  | Bank AlJazira |Customer complaint|Wrong information|Dispute Occoured |dev_SABJAZ_allAccess_user|dev_SABJAZ_allAccess_user|%RUNTIME% |                |Final Resolution      | dev_SABJAZ_disputeteam_user|dev_SABJAZ_disputeteam_user|   Rejected     |dev_SAALBI_allAccess_user2| dev_SAALBI_allAccess_user2|
