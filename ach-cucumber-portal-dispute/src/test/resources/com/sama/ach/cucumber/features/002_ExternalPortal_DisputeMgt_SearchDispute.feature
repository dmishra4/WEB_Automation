@Ext_SearchDispute
Feature: Search for Dispute under Dispute Management
  @Ext_SearchUsingDisputeID
...
#    And The "Search for Dispute" result table contains the following columns:
    ...
    Examples: 
      ...
      |    Chrome   | External    |dev_SAALBI_allAccess_user|dev_SAALBI_allAccess_user|       1000000000000154              |
...
#    And The "Search for Dispute" result table contains the following columns:
    ...
    Examples: 
      ...
      |    Chrome   | External    |dev_SAALBI_allAccess_user|dev_SAALBI_allAccess_user| 20190808000000045C1B000000000003010 |
    # |    Firefox  | External    |dev_SAALBI_allAccess_user|dev_SAALBI_allAccess_user| 20190808000000045C1B000000000003010 |
...
#    And The "Search for Dispute" result table contains the following columns:
    ...
    Examples: 
      ...
      |    Chrome   | External    |dev_SAALBI_allAccess_user|dev_SAALBI_allAccess_user|  10/06/2020  |10/06/2020|  AlBilad Bank |  All           |   All          |
    # |    Firefox  | External    |dev_SAALBI_allAccess_user|dev_SAALBI_allAccess_user| 20190808000000045C1B000000000003010 |
