@Ext_DisputeStatus
Feature: 010_ExternalPortal_DisputeMgt_DisputeStatus_Disputer Party - Sent to Counter Party
 @10_Ext_DS_DisputerPartySenttoCounterParty
  Scenario Outline: Disputer Party - Sent to Counterparty Status Check
...
#     |    Chrome   | External    |dev_SAALBI_allAccess_user|dev_SAALBI_allAccess_user| 20190808000000045C1B000000000003010 |AlBilad Bank  | Bank AlJazira |Customer complaint|Wrong information|Dispute Occoured |dev_SABJAZ_allAccess_user|dev_SABJAZ_allAccess_user|%RUNTIME% |                |Final Resolution      | dev_SABJAZ_disputeteam_user|dev_SABJAZ_disputeteam_user|   Rejected     |dev_SAALBI_allAccess_user2| dev_SAALBI_allAccess_user2|
      |    Firefox  | External    |dev_SAALBI_allAccess_user|dev_SAALBI_allAccess_user| 20190808000000045C1B000000000003010 |AlBilad Bank  | Bank AlJazira |Customer complaint|Wrong information|Dispute Occoured |dev_SABJAZ_allAccess_user|dev_SABJAZ_allAccess_user|%RUNTIME% |                |Final Resolution      | dev_SABJAZ_disputeteam_user|dev_SABJAZ_disputeteam_user|   Rejected     |dev_SAALBI_allAccess_user2| dev_SAALBI_allAccess_user2|
